...
public class MainActivity2 extends AppCompatActivity implements Asynchtask {
    ...
    public void processFinish(String result) throws JSONException {
        ...
        for (int i = 0; i < lugaresArray.length(); i++) {
            ...
            //en esta parte mostramos como se realiza la distribucion de info
            lugaresStringBuilder.append("Categoria: ").append(categoria).append("\n");
            lugaresStringBuilder.append("Nombre del L.Turistico: ").append(nombreLugar).append("\n");
            lugaresStringBuilder.append("N° Teléfono: ").append(telefono).append("\n\n");

        }
        // podemos ver que dentro del texview se evidencia la info
        txtBancos.setText("Datos sobre el lugar:\n" + lugaresStringBuilder.toString());
    }
}
